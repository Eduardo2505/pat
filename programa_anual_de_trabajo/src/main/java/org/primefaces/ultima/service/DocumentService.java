...
public class DocumentService {
    ...
    public TreeNode createCheckboxDocuments() {
		...
		TreeNode documents = new CheckboxTreeNode(new Document("ACTIVO - 1000000 ", "-", ""), root);
		TreeNode pictures = new CheckboxTreeNode(new Document("PASIVO - 2000000", "-", ""), root);
		//TreeNode movies = new CheckboxTreeNode(new Document("30000000", "-", "CUENTAS POR PAGAR"), root);
		
		TreeNode work = new CheckboxTreeNode(new Document("CIRCULANTE", "1100000", ""), documents);
		TreeNode primefaces = new CheckboxTreeNode(new Document("CUENTAS POR COBRAR", "110400000", ""), documents);
		
		//Documents
		TreeNode expenses = new CheckboxTreeNode("document", new Document("CAJA", "1030000", "-"), work);
		TreeNode resume = new CheckboxTreeNode("document", new Document("BANCOS", "1065000", "-"), work);
		TreeNode refdoc = new CheckboxTreeNode("document", new Document("DUDORES DIVERSOS", "1048900", "-"), primefaces);
		
		//Pictures
		TreeNode barca = new CheckboxTreeNode("picture", new Document("INVENTARIOS", "2054000", "-"), pictures);
		TreeNode primelogo = new CheckboxTreeNode("picture", new Document("FINANCIAMINETO", "2330000", "-"), pictures);
		TreeNode optimus = new CheckboxTreeNode("picture", new Document("PRESTAMO AL PERSONAL", "278500", "-"), pictures);
