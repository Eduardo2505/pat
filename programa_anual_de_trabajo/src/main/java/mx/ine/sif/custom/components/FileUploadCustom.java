 ...
 */
package mx.ine.sif.custom.components;
...
@ResourceDependencies({
	...
	@ResourceDependency(library="js", name="fileupload2/fileupload.css"),
	@ResourceDependency(library="primefaces", name="jquery/jquery.js"),
	@ResourceDependency(library="primefaces", name="jquery/jquery-plugins.js"),
	@ResourceDependency(library="primefaces", name="core.js"),
	@ResourceDependency(library="primefaces", name="components.js"),
	@ResourceDependency(library="js", name="fileupload2/fileupload.js")
})
public class FileUploadCustom extends FileUpload implements org.primefaces.component.api.Widget {


	public static final String COMPONENT_TYPE = "mx.ine.sif.custom.components.FileUploadCustom";
	public static final String COMPONENT_FAMILY = "org.primefaces.component";
	private static final String DEFAULT_RENDERER = "mx.ine.sif.custom.components.FileUploadRendererCustom";
	...
	public boolean isCompletar() {
		return (java.lang.Boolean) getStateHelper().eval(PropertyKeys.completar, false);
	}
	public void setCompletar(boolean _completar) {
		getStateHelper().put(PropertyKeys.completar, _completar);
	}
