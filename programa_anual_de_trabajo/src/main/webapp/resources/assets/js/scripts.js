    ...
    */
    $('.register form').submit(function(){
       /* $(this).find("label[for='firstname']").html('First Name');
        ...
        $(this).find("label[for='username']").html("<span class='red'><strong>* </strong></span>Nombre de usuario:");
        //$(this).find("label[for='email']").html('Email');
        $(this).find("label[for='password']").html("<span class='red'><strong>* </strong></span>Contraseña:");
        ////
        ...
        if(username == '') {
            $(this).find("label[for='username']").append("<span style='display:none' class='red'> - Por favor introduzca un nombre de usuario válido.</span>");
        ...
        if(password == '') {
            $(this).find("label[for='password']").append("<span style='display:none' class='red'> - Por favor introduzca una contraseña válida.</span>");
